import{b as ot}from"./chunk-VCY22VL4.js";import{f as re,g as se,h as rt,i as le,j as ce}from"./chunk-WGTMRNKZ.js";import{d as ie,g as ne,k as ae,t as oe}from"./chunk-AO7JHD55.js";import{$ as q,$a as X,$c as Je,Aa as Ne,Ac as v,Cc as Ue,Da as w,Ea as E,Ec as Qe,F as fe,Fa as I,G as _e,Gb as qe,Gc as P,H as T,Ja as D,Ka as h,Kb as Z,Kc as V,La as g,Lb as l,M as d,Ma as R,Mb as be,Mc as Ye,N as u,P as o,Q as Te,R as De,Rc as Xe,S as Re,Ta as He,Tc as ve,U as Fe,Ua as Q,Uc as xe,Va as b,Vc as Ze,X as S,Xa as y,Y as W,Ya as Y,Yc as $e,Za as F,_a as Be,ab as x,ba as Pe,bb as k,bd as et,c as _,ca as K,da as G,dd as ee,fa as Ve,fb as ze,ga as O,gd as te,h as Ee,hb as C,hd as tt,ib as je,jb as N,kb as ge,la as m,lb as We,na as Le,o as he,oa as L,oc as $,q as Ie,qc as Ke,rc as J,rd as ke,sb as H,sd as it,td as nt,u as j,uc as ye,v as ue,va as M,vc as Ge,vd as at,wa as p,xa as U,z as Ae}from"./chunk-KJR3TKRO.js";var st=(()=>{class n{_animationsDisabled=te();state="unchecked";disabled=!1;appearance="full";static \u0275fac=function(t){return new(t||n)};static \u0275cmp=M({type:n,selectors:[["mat-pseudo-checkbox"]],hostAttrs:[1,"mat-pseudo-checkbox"],hostVars:12,hostBindings:function(t,i){t&2&&C("mat-pseudo-checkbox-indeterminate",i.state==="indeterminate")("mat-pseudo-checkbox-checked",i.state==="checked")("mat-pseudo-checkbox-disabled",i.disabled)("mat-pseudo-checkbox-minimal",i.appearance==="minimal")("mat-pseudo-checkbox-full",i.appearance==="full")("_mat-animation-noopable",i._animationsDisabled)},inputs:{state:"state",disabled:"disabled",appearance:"appearance"},decls:0,vars:0,template:function(t,i){},styles:[`.mat-pseudo-checkbox {
  border-radius: 2px;
  cursor: pointer;
